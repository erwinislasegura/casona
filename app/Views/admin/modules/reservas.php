...
<div class="module-card reservations-view">
  ...
  <div class="module-toolbar"><a class="admin-mini-button" href="<?= $basePath ?>/admin/registros">Todas</a><a class="admin-mini-button is-ghost" href="<?= $basePath ?>/admin/registros?status=pending">Pendientes</a><a class="admin-mini-button is-ghost" href="<?= $basePath ?>/admin/entradas">Ver entradas emitidas</a></div>
