<div class="module-card scanner-view scanner-module is-camera-ready">
  <div class="scanner-copy">
    <span class="module-kicker">Validación</span><h2>Escáner QR</h2>
  ...
  <form method="post" class="scanner-card" data-scanner-form>
    ...
    <div class="scanner-camera-box"><video data-scanner-video playsinline muted></video><div class="scanner-reticle" aria-hidden="true"></div></div>
    ...
    <div class="scanner-controls"><button class="admin-primary-button" type="button" data-scanner-start>Abrir cámara</button><button class="admin-secondary-button" type="button" data-scanner-torch>Linterna</button><button class="admin-secondary-button" type="submit">Validar manual</button></div>
  </form>
</div>
