...
<body class="login-body has-mobile-app-nav">
  <header class="container pt-3 pt-lg-4">
    <nav class="navbar navbar-expand-lg rounded-4 px-3 py-2" style="background:rgba(15,23,48,.88);border:1px solid rgba(255,255,255,.13)">
      <a class="navbar-brand d-flex align-items-center gap-2 text-white fw-black" href="/admin">
        <span class="logo-badge" style="width:42px;height:42px"><img src="/assets/logo-ciclon.jpeg" alt="Ciclón Producciones"></span>
      ...
      <div class="ms-auto d-flex align-items-center gap-2 small">
        ...
        <a class="btn btn-sm btn-outline-light" href="/admin/logout">Cerrar sesión</a>
      </div>
    </nav>
  </header>
  ...
  <main class="container py-3 py-lg-4">
    <section class="login-card card border-0 shadow-lg w-100" style="max-width:none">
      <div class="card-body p-3 p-lg-4">
        ...
        <div class="row g-3">
          <div class="col-12 col-md-6 col-xl-3"><a class="btn btn-warning w-100 py-3 fw-black" href="/admin/reservas?status=pending">Solicitudes pendientes</a></div>
          <div class="col-12 col-md-6 col-xl-3"><a class="btn btn-outline-light w-100 py-3 fw-black" href="/admin/scanner">Escanear entradas</a></div>
          <div class="col-12 col-md-6 col-xl-3"><a class="btn btn-outline-light w-100 py-3 fw-black" href="/admin/entradas">Entradas</a></div>
          <div class="col-12 col-md-6 col-xl-3"><a class="btn btn-outline-light w-100 py-3 fw-black" href="/admin/configuracion">Configuración</a></div>
        </div>
      </div>
    </section>
  </main>
  ...
  <nav class="mobile-app-nav d-md-none" aria-label="Navegación móvil del panel">
    ...
    <a href="/admin/reservas?status=pending">Solicitudes</a>
